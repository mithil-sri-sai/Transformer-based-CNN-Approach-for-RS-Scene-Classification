...
path = r'C:/Users/ArrunPersonal/Codes/SceneRecognition Remote Sensing/CEN_AMP/CEN_AMP_New/CEN_AMP_splitted'
bs = 8
sz = 224
...
model.head = nn.Sequential(create_cls_module(nf=model.num_features, n_out=dls.c))
